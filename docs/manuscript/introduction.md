...
> ≈L201–314). ~720 words. Citation keys resolved 2026-06-20; all placeholders replaced with
> author-year keys matching `references.bib`. The repurposing gap is framed as motivation,
> not asserted (author guidance); method kept subordinate.
