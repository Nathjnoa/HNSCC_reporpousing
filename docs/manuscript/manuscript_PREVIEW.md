...
Partial preview for pipeline testing: Introduction, Methods, Results, Discussion, main-body figures (Fig 1-6) and the prioritized-candidate main table (Table 1). Abstract, Title and complete Methods/Results citations are pending (WRITING_PLAN.md steps 6-8). Citations shown are PubMed-verified; the bibliography is generated by pandoc / scanned in Zotero.
