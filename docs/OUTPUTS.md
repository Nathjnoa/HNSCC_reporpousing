...
- `results/figures/pub/main/Fig2A_volcano.pdf` (148.92K)
- `results/figures/pub/main/Fig2A_volcano.png` (327.31K)
- `results/figures/pub/main/Fig2B_heatmap_topDE.pdf` ( 13.8K)
- `results/figures/pub/main/Fig2B_heatmap_topDE.png` (204.8K)
- `results/figures/pub/main/Fig2C_hallmarks_gsea.pdf` ( 28.41K)
- `results/figures/pub/main/Fig2C_hallmarks_gsea.png` (128.49K)
- `results/figures/pub/main/Fig2_multipanel.pdf` (171.36K)
- `results/figures/pub/main/Fig2_multipanel.png` (488.45K)
- `results/figures/pub/main/Fig2_multipanel.tif` (  3.15M)
- `results/figures/pub/main/Fig3A_drug_sources_bar.pdf` ( 17.16K)
- `results/figures/pub/main/Fig3A_drug_sources_bar.png` ( 49.03K)
- `results/figures/pub/main/Fig3B_drug_phase_dist.pdf` ( 23.16K)
- `results/figures/pub/main/Fig3B_drug_phase_dist.png` ( 93.66K)
...
- `results/figures/pub/main/Fig4B_module_barplot.png` ( 83.81K)
- `results/figures/pub/main/Fig4C_class_distribution.pdf` ( 18.81K)
- `results/figures/pub/main/Fig4C_class_distribution.png` ( 89.07K)
